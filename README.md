...
**🎓 Membres :** Ferencz ROUDET · Farouk LASFAR · Sacha EHRMANN · Aymeric FENARD  
...
**1. 🗺️ Comprendre les inégalités selon le contexte géographique**  
...
**3. ⚖️ Prendre conscience du poids des choix et des ressources disponibles**  
...
**4. 🏗️ Appréhender les mécanismes systémiques de discrimination et de vulnérabilité**  
...
## 🕹️ Description des fonctionnalités
...
3. ➡️ Avance sur le plateau selon le résultat de son action
...
- 🗺️ Un **plateau double face** (Natif / Mobilité) ou deux plateaux côte à côte
- 🎭 Un **deck de cartes Personnage** (tirage aléatoire en début de partie)
- 🌩️ Un **deck de cartes Événement** (pioche aléatoire à chaque tour)
...
1. 🌩️ **Piocher une carte Événement** → appliquer ses effets immédiatement
...
6. ➡️ **Avancer** du nombre de cases correspondant au résultat
...
- 🏚️ Problème de logement (expulsion, loyer augmenté)
- 🤒 Arrêt maladie
...
- ☀️ Journée sans contrainte administrative
...
| 🏛️ Rendez-vous préfecture / ambassade | 📋 Gérer l'administratif |
...
#### Scénario 2 — ✈️ L'étudiant en mobilité avec visa précaire
...
- 🏛️ Le plateau Mobilité contient **+30 % de cases administratives** vs le plateau Natif
